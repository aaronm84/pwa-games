...
| 🪷 **Ripples** — skip stones across a living 3D pond (engine-kit: Babylon.js + Havok); every skip ripples, wake the lotus | [`ripples-pwa/`](ripples-pwa/) | https://aaronm84.github.io/pwa-games/ripples/ |
