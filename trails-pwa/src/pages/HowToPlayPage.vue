      ...
      <div class="content-container">
        ...
        <div class="instructions">
          ...
          <div class="instruction-card">
            ...
            <h2>Objective</h2>
            <p>
              You and two CPU rivals each have a token on the edge of the board. Lay
              path tiles to keep your token moving — the <strong>last token still on
              the board</strong> wins. Run off the edge and you're out.
            </p>
          </div>
          ...
          <div class="instruction-card">
            ...
            <h2>Tips</h2>
            <ul>
              <li><strong>Rotate to curve inward</strong> — steer away from the edges</li>
              <li>Look at where the path's <strong>far end</strong> lands before placing</li>
              <li>Use opponents' tiles: a good path can run you somewhere safe for free</li>
              <li>Late game, <strong>hug the centre</strong> where there's room to keep going</li>
            </ul>
          </div>
        </div>
