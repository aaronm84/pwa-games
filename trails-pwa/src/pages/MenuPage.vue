  ...
  <q-page class="menu-page">
    ...
    <div class="menu-content">
      ...
      <div class="title-section">
        <h1 class="game-title">
          <span class="title-emphasis">Trails</span>
        </h1>
        <p class="game-subtitle">Lay the path, stay on the board</p>
      </div>
        ...
        >
          <div class="btn-content">
            ...
            <div class="btn-text">
              ...
              <div class="btn-sublabel">Outlast two CPU rivals</div>
            </div>
          </div>
        </q-btn>
      ...
      <!-- Progress Info -->
      <div v-if="trails.gamesPlayed > 0" class="progress-info">
        <div class="progress-stat">
          <q-icon name="emoji_events" size="sm" color="yellow-6" />
          <span>{{ trails.gamesWon }} of {{ trails.gamesPlayed }} games won</span>
        </div>
        <div class="progress-stat">
          <q-icon name="local_fire_department" size="sm" color="orange-6" />
          <span>Win streak: {{ trails.streak }} (best {{ trails.bestStreak }})</span>
        </div>
      </div>
    </div>
  </q-page>
...
const { trails } = storeToRefs(progressStore)
