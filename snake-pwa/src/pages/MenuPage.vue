  ...
  <q-page class="menu-page">
    ...
    <div class="menu-content">
      ...
      <div class="title-section">
        <h1 class="game-title">
          <span class="title-emphasis">Snake</span>
        </h1>
        <p class="game-subtitle">Eat, grow, don't crash</p>
      </div>
        ...
        >
          <div class="btn-content">
            ...
            <div class="btn-text">
              ...
              <div class="btn-sublabel">Swipe or arrow keys to steer</div>
            </div>
          </div>
        </q-btn>
        ...
        >
          <div class="btn-content">
            ...
            <div class="btn-text">
              ...
              <div class="btn-sublabel">Haptics, theme & wrap walls</div>
            </div>
          </div>
        </q-btn>
      </div>
      ...
      <!-- Progress Info -->
      <div v-if="snake.gamesPlayed > 0" class="progress-info">
        <div class="progress-stat">
          <q-icon name="emoji_events" size="sm" color="yellow-6" />
          <span>Best score: {{ snake.bestScore }}</span>
        </div>
        <div class="progress-stat">
          <q-icon name="sports_esports" size="sm" color="green-6" />
          <span>{{ snake.gamesPlayed }} games played</span>
        </div>
      </div>
    </div>
  </q-page>
...
const { snake } = storeToRefs(progressStore)
