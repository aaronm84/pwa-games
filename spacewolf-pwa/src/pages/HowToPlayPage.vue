      ...
      <div class="content-container">
        ...
        <div class="instructions">
          ...
          <div class="instruction-card">
            ...
            <h2>Objective</h2>
            <p>
              Your ship flies forward on rails. Steer through the lane, dodge
              hazards, and shred enemy fighters. Stay alive long enough to clear
              the sector and pile up score.
            </p>
          </div>
...
@media (max-width: 600px) {
  ...
  .instruction-card h2 { font-size: 1.3rem; }
  .instruction-card p,
  .instruction-card ol,
  .instruction-card ul { font-size: 0.95rem; }
}
</style>
