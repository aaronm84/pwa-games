  ...
  <q-page class="menu-page">
    ...
    <div class="menu-content">
      ...
      <div class="title-section">
        ...
        <p class="game-subtitle">All ships, report in</p>
      </div>
        ...
        >
          <div class="btn-content">
            ...
            <div class="btn-text">
              ...
              <div class="btn-sublabel">Launch into the dogfight</div>
            </div>
          </div>
        </q-btn>
      ...
      <!-- Progress Info -->
      <div v-if="game.bestScore > 0" class="progress-info">
        <div class="progress-stat">
          <q-icon name="emoji_events" size="sm" color="yellow-6" />
          <span>Best score: {{ game.bestScore.toLocaleString() }}</span>
        </div>
        <div class="progress-stat">
          <q-icon name="flight" size="sm" color="green-6" />
          <span>Runs completed: {{ game.runsCompleted }}</span>
        </div>
      </div>
    </div>
  </q-page>
...
const { game } = storeToRefs(progressStore)
