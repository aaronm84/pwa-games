      ...
      <q-card class="settings-card q-mb-md">
        <q-card-section>
          ...
          <div class="text-body2 text-white q-mb-md" style="opacity: 0.9;">
            Best score: {{ progressStore.game.bestScore.toLocaleString() }}<br />
            Runs completed: {{ progressStore.game.runsCompleted }}
          </div>
...
function confirmReset() {
  ...
  $q.dialog({
    ...
    message: 'This permanently clears your best score and run history. Continue?',
    cancel: true,
    persistent: true,
    dark: true,
  }).onOk(async () => {
