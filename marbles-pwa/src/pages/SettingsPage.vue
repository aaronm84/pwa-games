      ...
      <q-card class="settings-card q-mb-md">
        <q-card-section>
          ...
          <div class="text-body2 text-white q-mb-md" style="opacity: 0.9;">
            Best score: {{ progressStore.marbles.bestScore }}<br />
            Highest level: {{ progressStore.marbles.highestLevel }} ·
            {{ progressStore.marbles.gamesPlayed }} games
          </div>
...
function confirmReset() {
  ...
  $q.dialog({
    ...
    await progressStore.resetMarblesProgress()
    haptics.success()
  })
}
</script>
