  ...
  <q-page class="menu-page">
    ...
    <div class="menu-content">
      ...
      <div class="title-section">
        <h1 class="game-title">
          <span class="title-emphasis">Slots</span>
        </h1>
        <p class="game-subtitle">Spin the reels, chase the jackpot</p>
      </div>
        ...
        >
          <div class="btn-content">
            ...
            <div class="btn-text">
              ...
              <div class="btn-sublabel">Gem Fortune — 5 reels</div>
            </div>
          </div>
        </q-btn>
      ...
      <div class="progress-info">
        <div class="progress-stat">
          <q-icon name="paid" size="sm" color="yellow-6" />
          <span>Credits: {{ casino.credits.toLocaleString() }}</span>
        </div>
        <div class="progress-stat">
          <q-icon name="diamond" size="sm" color="cyan-4" />
          <span>Jackpot: {{ casino.jackpot.toLocaleString() }}</span>
        </div>
        <div v-if="casino.bestWin > 0" class="progress-stat">
          <q-icon name="emoji_events" size="sm" color="green-6" />
          <span>Best win: {{ casino.bestWin.toLocaleString() }}</span>
        </div>
      </div>
    </div>
  </q-page>
