<template>
  <q-page class="menu-page">
    ...
    <div class="menu-content">
        ...
        >
          <div class="btn-content">
            ...
            <div class="btn-text">
              ...
              <div class="btn-sublabel">{{ ripples.currentLevel > 1 ? `Continue from level ${ripples.currentLevel}` : 'Start from level 1' }}</div>
            </div>
          </div>
        </q-btn>
      ...
      <!-- Progress Info -->
      <div v-if="ripples.currentLevel > 1 || ripples.totalScore > 0" class="progress-info">
        <div class="progress-stat">
          <q-icon name="stars" size="sm" color="yellow-6" />
          <span>Total stars: {{ ripples.totalScore }}</span>
        </div>
        <div class="progress-stat">
          <q-icon name="water" size="sm" color="light-blue-3" />
          <span>Level reached: {{ ripples.currentLevel }}</span>
        </div>
      </div>
    </div>
  </q-page>
...
const { ripples } = storeToRefs(progressStore)
