  ...
  <q-page class="menu-page">
    ...
    <div class="menu-content">
      ...
      <div class="title-section">
        <h1 class="game-title">
          <span class="title-emphasis">Tank Wars</span>
        </h1>
        <p class="game-subtitle">Artillery duel — aim, fire, destroy</p>
      </div>
        ...
        >
          <div class="btn-content">
            ...
            <div class="btn-text">
              ...
              <div class="btn-sublabel">Battle the CPU</div>
            </div>
          </div>
        </q-btn>
      ...
      <!-- Progress Info -->
      <div v-if="tankwars.gamesPlayed > 0" class="progress-info">
        <div class="progress-stat">
          <q-icon name="emoji_events" size="sm" color="yellow-6" />
          <span>{{ tankwars.gamesWon }} of {{ tankwars.gamesPlayed }} battles won</span>
        </div>
        <div class="progress-stat">
          <q-icon name="local_fire_department" size="sm" color="orange-6" />
          <span>Win streak: {{ tankwars.streak }} (best {{ tankwars.bestStreak }})</span>
        </div>
      </div>
    </div>
  </q-page>
...
const { tankwars } = storeToRefs(progressStore)
const haptics = useHaptics()

function playGame() {
  haptics.medium()
  router.push({ name: 'tankwars' })
}
