  ...
  <q-page class="menu-page">
    ...
    <div class="menu-content">
      ...
      <div class="title-section">
        ...
        <p class="game-subtitle">Hold the line, wave after wave</p>
      </div>
        ...
        >
          <div class="btn-content">
            ...
            <div class="btn-text">
              ...
              <div class="btn-sublabel">Pick a map &amp; defend</div>
            </div>
          </div>
        </q-btn>
      ...
      <!-- Progress Info -->
      <div v-if="towers.bestWave > 0 || towers.bestScore > 0" class="progress-info">
        <div class="progress-stat">
          <q-icon name="emoji_events" size="sm" color="yellow-6" />
          <span>Best score: {{ towers.bestScore.toLocaleString() }}</span>
        </div>
        <div class="progress-stat">
          <q-icon name="waves" size="sm" color="green-6" />
          <span>Best wave: {{ towers.bestWave }}</span>
        </div>
      </div>
    </div>
  </q-page>
...
const { towers } = storeToRefs(progressStore)
