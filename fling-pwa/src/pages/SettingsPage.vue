      ...
      <q-card class="settings-card q-mb-md">
        <q-card-section>
          ...
          <div class="text-body2 text-white q-mb-md" style="opacity: 0.9;">
            Best score: {{ progressStore.fling.bestScore }}<br />
            Highest level: {{ progressStore.fling.highestLevel }} ·
            {{ progressStore.fling.gamesPlayed }} games
          </div>
...
function confirmReset() {
  ...
  $q.dialog({
    ...
    await progressStore.resetFlingProgress()
    haptics.success()
  })
}
</script>
