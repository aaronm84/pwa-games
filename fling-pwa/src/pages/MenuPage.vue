  ...
  <q-page class="menu-page">
    ...
    <div class="menu-content">
      ...
      <div class="title-section">
        <h1 class="game-title">
          <span class="title-emphasis">Fling</span>
        </h1>
        <p class="game-subtitle">Topple the towers, clear every target</p>
      </div>
      ...
      <!-- Progress Info -->
      <div v-if="fling.highestLevel > 1 || fling.bestScore > 0" class="progress-info">
        <div class="progress-stat">
          <q-icon name="emoji_events" size="sm" color="yellow-6" />
          <span>Best score: {{ fling.bestScore }}</span>
        </div>
        <div class="progress-stat">
          <q-icon name="stairs" size="sm" color="green-6" />
          <span>Highest level: {{ fling.highestLevel }}</span>
        </div>
      </div>
    </div>
  </q-page>
...
const { fling } = storeToRefs(progressStore)
