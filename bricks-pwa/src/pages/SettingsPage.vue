      ...
      <q-card class="settings-card q-mb-md">
        <q-card-section>
          ...
          <div class="text-body2 text-white q-mb-md" style="opacity: 0.9;">
            Best score: {{ progressStore.bricks.bestScore }}<br />
            Highest level: {{ progressStore.bricks.highestLevel }} ·
            {{ progressStore.bricks.gamesPlayed }} games
          </div>
...
function confirmReset() {
  ...
  $q.dialog({
    ...
    await progressStore.resetBricksProgress()
    haptics.success()
  })
}
</script>
